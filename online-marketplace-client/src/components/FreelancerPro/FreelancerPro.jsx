    ...
    return (
        <section>
            <div className="container mx-auto">
                <div className="lg:max-w-5xl font-onest sm:max-w-2xl max-sm:max-w-sm mx-auto mt-4">
                    <h2 className="text-gray-800 text-3xl font-extrabold border-b-2 border-gray-800 inline-block">Our freelancers</h2>
                    ...
                    <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-6 max-md:justify-center mt-12">
                        ...
                        <div className="grid grid-cols-3 items-center bg-gray-100 p-4 rounded-lg relative">
                            ...
                            <div className="bg-white rounded-lg p-4 absolute right-4 shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] ">
                                ...
                                <p className="text-[10px] text-gray-500 mt-0.5">United State</p>
                                <p className="text-gray-800 mt-2 text-xs">Digital Marketer</p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-3 items-center bg-gray-100 p-4 rounded-lg relative">
                            ...
                            <div className="bg-white rounded-lg p-4 absolute right-4 shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] ">
                                ...
                                <p className="text-[10px] text-gray-500 mt-0.5">United State</p>
                                <p className="text-gray-800 mt-2 text-xs">Graphic Designer</p>
                            </div>
                        </div>
