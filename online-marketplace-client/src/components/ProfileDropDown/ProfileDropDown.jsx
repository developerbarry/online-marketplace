...
export default function ProfileDropDown() {
    ...
    return (
        <div className="bg-gray-2 dark:bg-dark">
                ...
                <div className="flex justify-between">
                    <div className="relative inline-block">
                        <button
                            ...
                            className="mb-3.5 inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-stroke bg-black px-6 py-3 text-base font-medium text-dark dark:border-dark-3 dark:bg-dark-2 dark:text-white"
                        >
                            Account
                            <span
