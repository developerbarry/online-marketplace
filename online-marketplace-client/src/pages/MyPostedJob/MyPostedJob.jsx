                                        ...
                                        <tbody className='bg-white divide-y divide-gray-200 '>
                                            {
                                                postedJobs.map(postedJob => (
                                                    <tr key={postedJob._id}>
                                                        ...
                                                        <td className='px-4 py-4 text-sm text-gray-500  whitespace-nowrap'>
                                                            ${postedJob?.hourly_rate?.min} - ${postedJob?.hourly_rate?.max}
                                                        </td>
                                                        ...
                                                        >
                                                            {postedJob?.description.slice(0, 50)}...
                                                        </td>
                                                        <td className='px-4 py-4 text-sm whitespace-nowrap'>
                                                            <div className='flex items-center gap-x-6'>
                                                                ...
                                                                <Link to={`/update/${postedJob._id}`}  className='text-gray-500 transition-colors duration-200   hover:text-yellow-500 focus:outline-none'>
                                                                    <svg
                                                                        xmlns='http://www.w3.org/2000/svg'
                                                                        fill='none'
                                                                        viewBox='0 0 24 24'
